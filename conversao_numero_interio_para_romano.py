...
def int_to_roman(num):
    ...
    # Esses são os valores que podem ser representados diretamente em algarismos romanos
    val = [
        1000, 900, 500, 400,100, 90, 50, 40, 10, 9, 5, 4,1                    
    ]

    # Lista de símbolos romanos correspondentes aos valores acima
    # Cada símbolo está na mesma posição do valor correspondente na lista val
    syms = [
        "M", "CM", "D", "CD", "C", "XC", "L", "XL", "X", "IX", "V", "IV", "I"                    
    ]

    # Variável para armazenar o número romano final
    # Inicialmente, está vazia e será preenchida com os símbolos romanos
    roman_num = ''
...
try:
    ...
    if 1 <= numero <= 3999:
        # Se estiver dentro do intervalo, chama a função int_to_roman para converter o número
        # e exibe o resultado
